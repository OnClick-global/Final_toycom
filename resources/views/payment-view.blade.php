                ...
                <div class="row">
                            ...
                            <div class="card-body">
                                <form class="needs-validation" method="POST" id="payment-form"
                                    ...
                                    <button class="btn btn-block" type="submit">
                                        <img width="200"
                                             src="{{asset('public/assets/admin/img/1-1.png?v=3')}}"/>
                                    </button>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12 mb-4" style="cursor: pointer">
                        <div class="card">
                            <div class="card-body">
                                <form class="needs-validation" method="POST" id="payment-form"
                                      action="{{route('pay-myfatoorah-visa')}}">
                                    {{ csrf_field() }}
                                    <button class="btn btn-block" type="submit">
                                        <img width="200"
                                             src="{{asset('public/assets/admin/img/3-3.png?v=3')}}"/>
                                    </button>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form class="needs-validation" method="POST" id="payment-form"
                                    ...
                                    <button class="btn btn-block" type="submit">
                                        <img width="200"
                                             src="{{asset('public/assets/admin/img/2-2.png?v=3')}}"/>
                                    </button>
                                </form>
                            </div>
                        </div>
