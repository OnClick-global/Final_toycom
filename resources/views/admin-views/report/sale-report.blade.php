                ...
                <div class="media-body">
                    <div class="row">
                        <div class="col-lg mb-3 mb-lg-0">
                            <h1 class="page-header-title">{{trans('messages.sale')}} {{trans('messages.report')}} {{trans('messages.overview')}}</h1>
                        ...
                        <form action="javascript:" id="search-form" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 pt-4">
                                    ...
                                    <strong>
                                        {{trans('messages.total')}} {{trans('messages.item')}} {{trans('messages.qty')}}
                                        : <span
                                            id="item_count"> </span>
                                    </strong><br>
