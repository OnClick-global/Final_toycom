...
class PaymentController extends Controller
{
    public function payment(Request $request)
    {
        ...
        if ($request->has('callback')) {
            Order::withoutGlobalScopes()->where(['id' => $request->order_id])->update(['callback' => $request['callback']]);
        }
        ...
        $order = Order::withoutGlobalScopes()->where(['id' => $request->order_id, 'user_id' => $request['customer_id']])->first();
